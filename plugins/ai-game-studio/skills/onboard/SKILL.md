...
- Run `$ai-game-studio:sprint-status` to show the new contributor current progress.
- Run `$ai-game-studio:help` if the contributor needs guidance on what to work on next.
