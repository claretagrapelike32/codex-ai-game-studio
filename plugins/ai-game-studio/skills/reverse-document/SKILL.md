...
1. Run $ai-game-studio:balance-check on combat formulas (exponential scaling concern)
...
```
User: $ai-game-studio:reverse-document design src/gameplay/[system]
...
Agent: ✅ Written to design/gdd/[system-name].md
       ...
       - Run $ai-game-studio:balance-check to validate [curve]
