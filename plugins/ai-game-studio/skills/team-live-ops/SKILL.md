...
> "Usage: `$ai-game-studio:team-live-ops [season name or event description]` — Provide the name or description of the season or live event to plan."
...
- Run `$ai-game-studio:design-review` on the season design document for consistency validation.
- Run `$ai-game-studio:sprint-plan` to schedule content creation work for the season.
- Run `$ai-game-studio:team-release` when the season content is ready to deploy.
