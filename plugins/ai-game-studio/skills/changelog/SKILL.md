...
- Use `$ai-game-studio:patch-notes [version]` to generate a styled, saved version for public release.
- Use `$ai-game-studio:release-checklist` before publishing the changelog externally.
