...
**When to run:**
- Polish phase — before `$ai-game-studio:gate-check release`
...
Read:
- `.ai-game-studio/project.json` — engine (for engine-specific memory
...
> **Engine**: [engine]
> **Generated by**: $ai-game-studio:soak-test
...
5. Run `$ai-game-studio:bug-triage sprint` after the session to integrate any S1/S2 issues

If the verdict is FAIL, run `$ai-game-studio:smoke-check` again after fixing the issues."
