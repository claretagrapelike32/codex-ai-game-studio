...
- `$ai-game-studio:reverse-document [type] [path]` — [For which gap]
- `$ai-game-studio:architecture-decision` — [For which gap]
- `$ai-game-studio:sprint-plan` — [If production planning missing]
- `$ai-game-studio:milestone-review` — [If approaching deadline]
- `$ai-game-studio:onboard [role]` — [If new contributor joining]
...
*Generated by `$ai-game-studio:project-stage-detect` skill*
