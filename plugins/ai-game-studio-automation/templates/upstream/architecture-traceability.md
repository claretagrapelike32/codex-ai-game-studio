...
<!-- Living document — updated by $ai-game-studio:architecture-review after each review run.
...
| TR-[gdd]-002 | [filename] | [system name] | [one-line summary] | — | ❌ GAP | Needs `$ai-game-studio:architecture-decision [title]` |
...
**When running `$ai-game-studio:architecture-review`**: The skill will update this document
