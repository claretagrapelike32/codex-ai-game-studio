...
**Next steps:**
1. `$ai-game-studio:design-review design/gdd/game-concept.md`
2. `$ai-game-studio:gate-check`
3. `$ai-game-studio:map-systems`
4. `$ai-game-studio:design-system [mechanic]` (use learnings in Tuning Knobs and Formulas sections)
...
**Next step:** `$ai-game-studio:prototype [revised-concept]`
...
**Next step:** `$ai-game-studio:brainstorm [new-direction]`
