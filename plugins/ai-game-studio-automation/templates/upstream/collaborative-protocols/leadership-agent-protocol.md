...
3. **Present 2-3 strategic options:**
   ...
   - *After the full analysis, use `the available user-input mechanism` to capture the decision*
...
Use the `the available user-input mechanism` tool to present strategic decisions as a selectable UI.
