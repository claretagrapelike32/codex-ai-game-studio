...
Critical paths to verify before QA hand-off (run via `$ai-game-studio:smoke-check`):
...
*Results and sign-off are tracked in the QA sign-off report generated by `$ai-game-studio:team-qa` — not in this plan file.*

*Template: `.ai-game-studio/templates/test-plan.md`*
*Generated by: `$ai-game-studio:qa-plan` — do not edit this line*
