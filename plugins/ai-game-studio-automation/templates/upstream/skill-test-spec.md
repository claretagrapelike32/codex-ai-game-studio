...
Verified automatically by `$ai-game-studio:skill-test static` — no fixture needed.

- [ ] Has required frontmatter fields: `name`, `description`, `argument-hint`, `user-invocable`, `unsupported legacy tool declarations`
