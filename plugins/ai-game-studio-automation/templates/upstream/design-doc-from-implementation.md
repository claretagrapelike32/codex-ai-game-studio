...
- Run `$ai-game-studio:balance-check` on [specific aspect]
...
- [ ] **Balance pass**: Run `$ai-game-studio:balance-check` on progression curve
...
**Related Skills**:
- `$ai-game-studio:balance-check` — Validate formulas and progression
- `$ai-game-studio:architecture-decision` — Document technical decisions
- `$ai-game-studio:code-review` — Ensure code matches clarified design

---

*This document was generated by `$ai-game-studio:reverse-document design [path]`*
